...
struct buf
{
	...
	char		*b_addr;		/* virtual memory address */
	unsigned int	b_slot;			/* slot no. for physical I/O */
 ...
 * Note that b_forw/b_back must have the same offsets in both 'devtab'
 * and 'buf', so that pointers can be cast between them.
 */
struct devtab
{
...
#define B_TAPE		02000	/* this is a magtape */
