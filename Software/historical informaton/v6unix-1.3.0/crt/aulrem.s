// C run time library
// Unsigned remainder for longs, args are on the stack, result in r2,r3
...
L6:	s	r5,r1		// if so: subtract divisor
	joc	L7
	dec	r0
L7:	s	r4,r0
	inc	r3		// shift one into the result

L8:	dec	r12		// loop over all 32 bits
	jgt	L2

L9:	mov	r0,(r13)	// assign result
	mov	r1,@2(r13)
	b	(r11)
