...
break;
case 30:
	{ mustfld=1; yylval = setsymtab(yytext, NULL, fzero, NUM, symtab); RETURN(VAR); }
break;
case 31:
{
#ifdef FLOAT
...
#else
		yylval = setsymtab(yytext, NULL, atoi(yytext), CON|NUM, symtab); RETURN(NUMBER);
#endif
		}
break;
case 32:
...
break;
case 56:
{ yylval = setsymtab(yytext, tostring(""), fzero, STR, symtab); RETURN(VAR); }
break;
case 57:
	{ BEGIN str; clen=0; }
break;
...
break;
case 77:
	{ BEGIN A; cbuf[clen]=0; yylval = setsymtab(cbuf, tostring(cbuf), fzero, CON|STR, symtab); RETURN(STRING); }
break;
case 78:
